...
layout: post.njk
---
This is it. My first public website (that has an actual purpose). So, what's the plan?
...
But, why Odin and Raylib? Well, I've programmed a lot in higher level languages, and returning to C, Odin, or (yes I know it's not super low level, but it's better than the others) Rust always makes me feel good when I program. In terms of choosing Raylib, I'm not a super hardcore programmer that wants to manually edit the framebuffer, and Raylib offered a good balance of being hands off and providing features that I'd like to not do manually.
